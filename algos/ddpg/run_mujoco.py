...
def parse_args():
    ...
    parser.add_argument('--updates', type=int, default=1, help='number of updates per sample')
    ...
    parser.add_argument('--expl_steps', type=int, default=int(1e3), help='number of exploratory steps before training')
...
def main(args):
    ...
    # Train PPO
    ddpg = TD3(env, MLPActor, MLPCritic, device, args)
    ddpg.train()

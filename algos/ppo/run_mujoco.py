...
def parse_args():
	...
	parser.add_argument('--env', type=str, default='Ant-v2', help='environment name')
	parser.add_argument('--threads', type=int, default=1, help='number of parallel threads to collect data')

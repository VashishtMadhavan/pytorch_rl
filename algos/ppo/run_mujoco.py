...
def parse_args():
    ...
    parser.add_argument('--seed', type=int, default=0, help='seed to set for gym, pytorch, and numpy')
    ...
    parser.add_argument('--log_iters', type=int, default=2048, help='log at this frequency of timesteps')
...
def main(args):
    # Load Mujoco Env
    env = make_mujoco_env(args.env, args.seed, normalize=True)
